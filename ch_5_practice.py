...
# Call the function
def joke():
    print("why did the right triangle go to the beach? Cause it was 90 degrees!")
...
def line5():
    print("Robin you, hand over the cash!")
...
def area(radius_squared):
    my_area = 3.14 * radius_squared  # TODO insert the PI constant multiplied by the parameter here
...
print(str(number_to_round) + " is rounded to " + str(rounded))
